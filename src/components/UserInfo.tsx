...
const UserInfo = () => {
  return (
    <div className="min-w-[327px] h-[517px] mt-4 rounded-2xl bg-[#1E2A47]">
      <div className="flex flex-row pl-6 mt-8">
        <img src={OctoCat} alt="octocat" className="w-[70px] h-[70px]" />
        <div className="flex flex-col ml-5">
          <h1 className="font-bold text-base text-white">The Octocat</h1>
          <a href="#" className="text-[#0079FF] font-normal text-[13px]">
            @octocat
          </a>
          <span className="font-normal text-[13px] text-[#FFFFFF] leading-[19.25px] mt-[6px]">
            Joined 25 Jan 2011
          </span>
        </div>
      </div>
      <p className="mx-6 mt-8 text-[13px] text-white leading-6">
        Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio.
        Quisque volutpat mattis eros.
      </p>
      <div className="flex bg-[#141D2F] mx-6 mt-6 text-white text-center rounded-xl py-[19px] px-[14px]">
        <div className="flex flex-row text-center mx-auto gap-8">
          <div>
            <h3 className="text-[11px]">Repos</h3>
            <span className="text-[16px]">8</span>
          </div>
          <div>
            <h3 className="text-[11px]">Followers</h3>
            <span className="text-[16px]">3938</span>
          </div>
          <div>
            <h3 className="text-[11px]">Following</h3>
            <span className="text-[16px]">9</span>
          </div>
        </div>
      </div>

      <div className="flex flex-col space-y-4 px-6 mt-6 text-center text-white">
